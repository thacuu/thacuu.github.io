  ...
  window.Marquee3k = function(options) {
    ...
    function init() {
      for (var i = 0; i < marquees.length; i++) {
        ...
        if (options.randomSpeed && !marquee.dataset.speed) {
          var random = Math.floor(Math.random() * 80) + 30;
        ...
        marqueeElem.style.paddingRight = marquee.dataset.spacing ? marquee.dataset.spacing : spacing;
        ...
        marquee.isPaused = marquee.hover;
    ...
    function resize() {
      for (var n = 0; n < marquees.length; n++) {
        ...
        marquee.contentHeight = getHeight(marquee);
        marquee.style.width = window.innerWidth + 'px';
        marquee.style.height = marquee.contentHeight + 'px';
        marqueeContentWrap.style.top = 'calc(50% - ' + (marquee.contentHeight / 2) + 'px)';
      }
    }
